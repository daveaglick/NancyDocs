...
To learn more on where Nancy looks for views, and how to customize the logic, check out [View location conventions](/docs/view-engines/view-location-conventions)
...
As part of the new [Content Negotiation](/docs/using-models/content-negotiation) features in 0.12, if Nancy could not find your view, the server will return 406 Not Acceptable instead.
