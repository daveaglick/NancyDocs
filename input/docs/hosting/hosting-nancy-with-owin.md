...
```
*Note: You must keep the Startup file's namespace the same as your application name or it will return a `403.14 - Forbidden`, If you want to keep it in a separate namespace or assembly you will have to add this into your config file..*
```xml
  <appSettings>
